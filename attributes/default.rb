...
#
default['consul-cluster']['tls']['ssl_key']['path'] = join_path config_prefix_path, 'ssl', 'private', 'consul.key'
...
default['consul-cluster']['tls']['ssl_cert']['path'] = join_path config_prefix_path, 'ssl', 'certs', 'consul.crt'
...
default['consul-cluster']['tls']['ssl_chain']['path'] = join_path config_prefix_path, 'ssl', 'certs', 'chain.crt'
